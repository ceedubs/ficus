...
//    val cfg = ConfigFactory.parseString(s"simple { bool = $bool }")
//    cfg.getConfig("simple").as[SimpleCaseClass] must beEqualTo(SimpleCaseClass)(bool = bool)
//  }
//
...
//        |}
//      """.stripMargin)
//    cfg.as[WithNestedValueClass]("withNestedValueClass") must beEqualTo(WithNestedValueClass)(
...
//        |}
//      """.stripMargin)
//    cfg.as[WithNestedCompanionImplicit]("withNestedCompanionImplicit") must beEqualTo(WithNestedCompanionImplicit)(
